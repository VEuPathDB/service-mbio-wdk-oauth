...
CREATE TABLE userlogins5.dataset_values (
  ...
  dataset_id             NUMERIC(12) NOT NULL,
  dataset_value_order    NUMERIC(12) NOT NULL,
...
CREATE TABLE userlogins5.strategies (
  ...
  last_view_time    TIMESTAMP DEFAULT CURRENT_DATE,
  last_modify_time  TIMESTAMP DEFAULT CURRENT_DATE,
